...
RETURNING id, session_id, role, content, tool_calls, tool_results, created_at, updated_at
`
...
SELECT id, session_id, role, content, tool_calls, tool_results, created_at, updated_at
FROM messages
WHERE id = ? LIMIT 1
`
